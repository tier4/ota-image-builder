...
def _dummy_metadata_payload_gen(
    cert_fname: str,
    cert_sha256_digest: str,
    ...
    return [
        ...
        {"certificate": cert_fname, "hash": cert_sha256_digest},  # must
...
def _dummy_jwt_gen():
    """
    NOTE: the JWT generated by this method DOESN'T follow JWT spec, but follow
