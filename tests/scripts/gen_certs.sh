...
# A simple script to generate a self-signed root CA, an intermediate CA, and a signing certificate.
# The generated certificates are suitable for testing purposes.
